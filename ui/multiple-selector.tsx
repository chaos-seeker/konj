  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'border-input ring-offset-background focus-within:ring-ring flex items-start justify-between rounded-md border bg-white px-3 py-2 text-sm focus-within:ring-2 focus-within:ring-offset-2',
            {
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'flex-1 self-baseline bg-transparent font-light outline-none placeholder:text-black',
                {
